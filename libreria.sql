...
INSERT INTO `libros` (`id_libro`, `titulo`, `autor`, `precio`, `paginas`, `fecha`, `categorias`, `editorial`, `sinopsis`, `imagen`) VALUES
...
(17, 'El señor de los anillos: el retorno del Rey', 'J.R.R. Tolkien', 19.95, 688, '1955-10-20', 'Novela de fantasía', 'Booket', 'Los ejércitos del Señor Oscuro van extendiendo cada vez más su maléfica sombra por la Tierra Media. Hombres, elfos y enanos unen sus fuerzas para presentar batalla a Sauron y sus huestes. Ajenos a estos preparativos, Frodo y Sam siguen adentrándose en el país de Mordor en su heroico viaje para destruir el Anillo de Poder en las Grietas del Destino.', 'LOTR3.jpg');
